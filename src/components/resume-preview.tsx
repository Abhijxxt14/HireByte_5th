...
const scrollToTop = () => {
 ...
 return (
  <>
    <div
      id="resume-preview"
      className="bg-card text-card-foreground p-2 md:p-3 rounded-lg print:p-0 print:m-0 print:rounded-none print:bg-white print:text-black print:shadow-none md:aspect-[8.5/11] md:shadow-2xl md:shadow-primary/10 md:transition-shadow md:duration-300 md:hover:shadow-primary/20"
    >
